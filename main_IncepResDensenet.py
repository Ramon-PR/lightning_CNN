# -*- coding: utf-8 -*-
"""
Created on Wed May  3 15:17:30 2023
...
from model_system_IncResDense import VisionModule, CallbackLog_loss_per_epoch
from Inception_Res_Densenet import model_dict
...
if __name__ == "__main__":
    ...
    densenet_model = VisionModule(
        model_name="DenseNet",
        model_dict=model_dict,
        model_hparams={
            "num_classes": config.HOUT*config.WOUT,
            "num_layers": [6, 6, 6, 6],
            "bn_size": 2,
            "growth_rate": 16,
            "act_fn_name": "relu",
    ...
    # %% FIT / VALIDATE / TEST
    trainer.fit(densenet_model, dm, ckpt_path=restart_file)
    ...
    img_out = densenet_model(torch.unsqueeze(dm.reference_image, dim=0))
