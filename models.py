...
class CNN_last_filters(torch.nn.Module):
    def __init__(self, n_channels: int = 1, 
        Hin: int = 32, Win: int = 32, 
        Hout: int = 32, Wout: int = 32,
        n_filters: list = [5, 5],
        ...
        self.last_filters = torch.nn.Conv2d(1, 1, 3, padding=1, stride=1)
...
model_dict["CNN_last_filters"] = CNN_last_filters
