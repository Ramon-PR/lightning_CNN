...
if __name__ == "__main__":
    ...
    model = CNNModule(
        ...
        model_hparams={
            ...
            "Hout" : config.HOUT ,
            "Wout" : config.WOUT ,
            "n_filtersB1" : config.N_FILTERS ,
            "conv_kernB1" : config.CONV_KERN ,
            "conv_padB1" : config.CONV_PAD ,
            "n_filtersB2" : config.N_FILTERS_B2 ,
            "conv_kernB2" : config.CONV_KERN_B2 ,
            "conv_padB2" : config.CONV_PAD_B2 ,
